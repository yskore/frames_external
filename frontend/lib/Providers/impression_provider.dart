...
final pieceImpressionCountProvider =
...
final impressionNotifierProvider = Provider<ImpressionNotifier>((ref) {
  ...
  return ImpressionNotifier(ref, pieceRepository);
});
...
class ImpressionNotifier {
  ...
  Future<bool> recordImpression(String pieceId,
    ...
    try {
      ...
      _ref.read(pieceImpressionCountProvider(pieceId).notifier).state =
          currentCount + 1;
      ...
      if (response.isSuccess) {
        ...
        if (response.data != null &&
            response.data!.containsKey('impressions')) {
